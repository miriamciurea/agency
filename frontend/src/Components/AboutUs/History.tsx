...
const History: React.FC = () => {
  return (
    ...
    >
      <p className="text-2xl leading-relaxed mb-4 font-extrabold" style={{ fontFamily: 'Radley', color: '#000' }}>
      ...
      <p className="text-2xl leading-relaxed font-extrabold" style={{ fontFamily: 'Radley', color: '#000' }}>
