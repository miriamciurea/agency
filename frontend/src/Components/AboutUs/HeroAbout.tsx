  ...
  return (
    <section ref={containerRef} className="p-[7%] gap-[20%]
      ...
      <div className="flex flex-col gap-[20px]
        ...
        <div className="">
          <button ref={buttonRef} className="button" onClick={scrollToMeetTheTeam}>Meet our Team</button>
        </div>
      </div>
      ...
      <div className="animate__animated animate__fadeInRight">
        <h1 className=" text-[1.6rem]
                        md:text-[2.4rem] md:font-[400] leading-tight">
        At MoonCode, we turn your vision into reality with custom web development services that empower your brand and drive your success.        </h1>
      </div>
    </section>
  );
};
